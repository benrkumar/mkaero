  ...
  return (
    <>
      ...
      <aside
        ...
        `}
        style={{ willChange: "transform", height: "var(--app-height, 100dvh)" }}
      >
...
function AppInner() {
  ...
  return (
    <div className="flex flex-1 overflow-hidden bg-slate-50 dark:bg-surface-900" style={{ height: "var(--app-height, 100dvh)" }}>
